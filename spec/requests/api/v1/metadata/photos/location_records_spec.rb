...
RSpec.describe "photo locations meta data records api" do
  context "when the record exists" do
    it "returns the current users photos location meta data" do
      user = create(:user)
      metadata_1 = MetaData.create(lat: 12.44441, long: 122.445454, user_id: user.id)
      metadata_2 = MetaData.create(lat: 12.12323, long: 112.451234, user_id: user.id)
      metadata_3 = MetaData.create(lat: 12.65751, long: 132.445454, user_id: user.id)
