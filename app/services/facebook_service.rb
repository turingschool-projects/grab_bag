class FacebookService
  ...
  def self.get_data(user)
    self.uploaded_photos_call
  end

  def self.uploaded_photos_call
    self.get_data_call("https://graph.facebook.com/v2.10/#{ENV['my_fb_id']}/photos?type=uploaded&access_token=#{ENV['my_fb_token']}")
